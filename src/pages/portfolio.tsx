...
const Portfolio: FC = memo(() => {
  ...
  const scenes = [
    {
      component: <StarfallScene key={1} isAnimationDone={isAnimationDone} isSceneLoaded={isSceneLoaded} mountRef={mountRef} setIsAnimationDone={setIsAnimationDone} setIsSceneLoaded={setIsSceneLoaded} />
    },
    {
      component: <DoesNotCommute key={2} isAnimationDone={isAnimationDone} isSceneLoaded={isSceneLoaded} mountRef={mountRef} setIsAnimationDone={setIsAnimationDone} setIsSceneLoaded={setIsSceneLoaded} />
    }
  ];
